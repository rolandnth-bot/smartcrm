...
export const Download = ({ size, className = '' }) => <span className={className} style={size ? { fontSize: `${size}px` } : {}}></span>;
export const Upload = ({ size, className = '' }) => <span className={className} style={size ? { fontSize: `${size}px` } : {}}></span>;
